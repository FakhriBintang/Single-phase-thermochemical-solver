...
% figure(6)
% subplot(1,3,1)
% imagesc(NUM.nxP,NUM.nzP,PHY.gxP); colormap(subplot(1,3,1),cm1); colorbar; axis ij image
% title('gx')
% 
% subplot(1,3,2)
% imagesc(NUM.nxP,NUM.nzP,PHY.gzP); colormap(subplot(1,3,2),cm1); colorbar; axis ij image
% title('gz')
% 
% subplot(1,3,3)
% imagesc(NUM.nxP,NUM.nzP,PHY.gP); colormap(subplot(1,3,3),cm1); colorbar; axis ij image
% hold on
% quiver(NUM.xP(xq),NUM.zP(zq),PHY.gxP(zq,xq),PHY.gzP(zq,xq),'k')
% title('g')
